...
# organizations.
#
# Requires: Orderer, pup peer1 & budget-peer1 to be available
# 1. Installs the CC to pup peer1 & budget-peer1
# 2. Instantiates CC on pup peer1
# 3. Executes query on budget-peer1
# 4. Executes invoke on pup peer1
...
CC_VERSION="1.0"
CC_CHANNEL_ID="shippingchannel"





# 1. Install CC on pup peer1 & budget-peer1
...
# 2. Instantiate the chaincode on pup peer1
...
# 4. Executes invoke on pup peer1
echo "====> 4   Execute invoke on pup peer1 - Transfer 10 from A=>B"
ORG_NAME="pup"
IDENTITY="admin"
PEER_NAME="peer1"
PEER_BASE_PORT=7050
