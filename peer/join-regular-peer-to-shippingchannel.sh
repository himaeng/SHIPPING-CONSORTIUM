# Joins the Regular peer to shipping channel

function usage {
    echo ". join-regualr-peer-to-shippingchannel.sh   ORG_NAME   PEER_NAME  [PORT_NUMBER_BASE default=7050] [ORDERER_ADDRESS default=loclahost:7050"
...
# 1. Fetch the 0th block for shipping channel
peer channel fetch 0 -c shippingchannel -o $ORDERER_ADDRESS
...
peer channel join -b shippingchannel_0.block -o $ORDERER_ADDRESS
