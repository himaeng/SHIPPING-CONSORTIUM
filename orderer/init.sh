...
configtxgen -profile ShippingOrdererGenesis -outputBlock ./airline-genesis.block -channelID ordererchannel

#3. Create the airline channel transaction
echo    '================ Writing airlinechannel ================'
configtxgen -profile ShippingChannel -outputCreateChannelTx ./airline-channel.tx -channelID airlinechannel
